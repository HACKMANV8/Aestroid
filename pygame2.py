...
def draw_hud(surface):
    ...
    stats_surf = pygame.Surface((hud_width, 100), pygame.SRCALPHA)
    pygame.draw.rect(stats_surf, (20, 20, 30, 200), (0, 0, hud_width, 100), border_radius=10)
    pygame.draw.rect(stats_surf, (60, 60, 80, 200), (0, 0, hud_width, 100), 2, border_radius=10)
